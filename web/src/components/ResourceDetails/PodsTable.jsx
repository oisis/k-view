                            ...
                            pods.map((pod, i) => (
                                <tr key={i} className="hover:bg-white/5 transition-colors">
                                    <td className="px-4 py-2">
                                        <Link to={`/pods/${pod.namespace}/${pod.name}`} className="font-bold text-accent hover:underline font-mono">
                                            {pod.name}
                                        </Link>
                                    </td>
                                    <td className="px-4 py-2 text-secondary">{pod.namespace}</td>
                                    ...
                                    <td className="px-4 py-2 text-text-muted text-xs">{pod.age}</td>
