...
export default function StatefulSetOverview({ data, spec, status, relatedPods, relatedServices, t }) {
    if (!data) return null;
    ...
    return (
        <div className="animate-in fade-in slide-in-from-bottom-2 duration-300 space-y-6">
            <ResourceInfoSection title="Resources Info" isDeployment={true} resource={data.resource} extra={data.extra} spec={spec} status={status} t={t} />
            <DetailSection title="Pods Status">
                <div className="p-4 text-sm text-secondary italic">Summary of pod status will be here</div>
            </DetailSection>
