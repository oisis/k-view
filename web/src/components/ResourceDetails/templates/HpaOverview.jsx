    ...
    return (
        <>
            <DetailSection title="Scaling Target">
                <div className="p-6 bg-[var(--bg-sidebar)]/5 border-b border-border">
            ...
            <DetailSection title="Replicas & Range" className="mt-4">
                <div className="grid grid-cols-3 divide-x divide-border bg-[var(--bg-sidebar)]/5 border-b border-border">
            ...
            <DetailSection title="Metrics" className="mt-4">
