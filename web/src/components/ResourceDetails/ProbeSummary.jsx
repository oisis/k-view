...
export default function ProbeSummary({ label, probe, t }) {
    ...
    return (
        <div className="flex flex-col gap-1 border-l-2 border-info/30 pl-2">
            <span className="text-xs font-black uppercase text-text-muted tracking-wider">{label} ({type})</span>
            <div className="text-xs font-mono text-info bg-info/5 px-1.5 py-0.5 rounded truncate max-w-[150px]" title={uri}>{uri}</div>
