...
func NewResourceHandler(devMode bool, k8sClient k8s.KubernetesProvider) *ResourceHandler {
	...
	registry.Register("configmaps", NewConfigMapManager())
	registry.Register("configmap", NewConfigMapManager())
	registry.Register("cm", NewConfigMapManager())
	registry.Register("secrets", NewSecretManager())
	registry.Register("secret", NewSecretManager())
	registry.Register("serviceaccounts", NewServiceAccountManager())
	registry.Register("serviceaccount", NewServiceAccountManager())
	registry.Register("sa", NewServiceAccountManager())
	registry.Register("resourcequotas", NewResourceQuotaManager())
	registry.Register("resourcequota", NewResourceQuotaManager())
	registry.Register("limitranges", NewLimitRangeManager())
	registry.Register("limitrange", NewLimitRangeManager())
	registry.Register("endpoints", NewEndpointsManager())
	registry.Register("endpoint", NewEndpointsManager())
	registry.Register("ep", NewEndpointsManager())
	registry.Register("horizontalpodautoscalers", NewHPAManager())
	registry.Register("horizontalpodautoscaler", NewHPAManager())
	registry.Register("hpa", NewHPAManager())
	registry.Register("namespaces", NewNamespaceManager())
	registry.Register("namespace", NewNamespaceManager())
	registry.Register("ns", NewNamespaceManager())
	registry.Register("events", NewEventManager())
	registry.Register("event", NewEventManager())
	registry.Register("ev", NewEventManager())
	registry.Register("customresourcedefinitions", NewCRDManager())
	registry.Register("customresourcedefinition", NewCRDManager())
	registry.Register("crd", NewCRDManager())
	registry.Register("replicationcontrollers", NewReplicationControllerManager())
	registry.Register("replicationcontroller", NewReplicationControllerManager())
	registry.Register("rc", NewReplicationControllerManager())
